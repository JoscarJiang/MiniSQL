...
void Interpreter::CreateClause(string SQL, int start) {
	...
	if (object_type == -2) {
		...
		switch (object_type)
		{
		case 0: CreateDatabase(SQL, start); break;
		default:
			break;
		}
	}
}
void Interpreter::CreateDatabase(string SQL, int start){

}
void Interpreter::CreateTable(CString SQL, int start){

}
void Interpreter::CreateIndex(CString SQL, int start){

}
void Interpreter::SelectClause(string SQL, int start){
}
void Interpreter::InsertClause(string SQL, int start){

}
void Interpreter::DropClause(string SQL, int start){

}
void Interpreter::UseClause(string SQL, int start){

}
void Interpreter::DeleteClause(string SQL, int start){

}
void Interpreter::ExecfileClause(string SQL, int start){

}
void Interpreter::HelpClause(string SQL, int start){

}
void Interpreter::QuitClause(string SQL, int start){
